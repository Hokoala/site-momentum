          ...
          <div className="lg:col-span-9 p-8 md:p-12 flex flex-col justify-center relative overflow-hidden bg-black">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm text-neutral-400 font-light leading-relaxed">
              ...
              <div>
                ...
                <Link
                  href="/game/join"
                  className="inline-flex items-center gap-2 text-white border-b border-primary hover:text-primary transition-colors uppercase font-bold tracking-widest text-xs pb-1"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-white/20">
          ...
          {[
            ...
            },
            {
              ...
              role: "Game & Web Developer",
              sub: "BACKEND",
              link: "https://portfolio-nine-kappa-50.vercel.app/",
            },
            {
              name: "Job-Faël Babalola",
              role: "Sound & Graphic Designer",
              sub: "SOUND/GFX",
              link: "http://mmi23f01.mmi-troyes.fr/portfolio/",
            },
            {
              name: "Théo Birost",
              role: "Graphic Designer & 3D Artist",
              sub: "3D/MOTION",
              link: "http://45.147.97.140/portfolio/",
            },
          ].map((c, i) => (
            <Link
              key={i}
            ...
            >
              <div className="absolute top-6 left-6 text-[10px] font-mono text-white/30 group-hover:text-primary transition-colors">
                MEMBER_0{i + 1}
              </div>
              ...
              <div className="space-y-2">
                <Badge
                  variant="outline"
                  className="rounded-none border-white/30 text-white/50 text-[9px] mb-1 group-hover:border-primary group-hover:text-primary uppercase"
                >
                  {c.sub}
                </Badge>
                <h3 className="text-lg font-bold uppercase text-white group-hover:text-primary transition-colors leading-tight">
                  {c.name}
                </h3>
                <p className="text-[10px] text-neutral-500 font-mono uppercase tracking-widest group-hover:text-white/70">
                  {c.role}
                </p>
              </div>

              {/* Corner decoration */}
              <div className="absolute bottom-0 right-0 w-3 h-3 border-b border-r border-white/20 group-hover:border-primary transition-colors"></div>
            </Link>
          ))}
        </div>
      </section>
